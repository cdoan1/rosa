...
func RegisterClusterCreateFlags(cmd *cobra.Command, input *ClusterCreateInput) {
	...
	registerIfNew(f, "oidc-config-id", func() { f.StringVar(&input.OidcConfigId, "oidc-config-id", "", "") })
...
// normalizeClusterCreateInput clears pointer flag fields that were pre-allocated by
